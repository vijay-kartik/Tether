...
/** WhatsApp binary-XML token dictionaries, generated verbatim from whatsmeow binary/token/token.go. */
internal object WaTokens {
    const val DICT_VERSION = 3

    val SINGLE: Array<String> = arrayOf(
        "",
        "xmlstreamstart",
        "xmlstreamend",
        "s.whatsapp.net",
    ...
    val DOUBLE: Array<Array<String>> = arrayOf(
        arrayOf(
            "read-self",
            "active",
            "fbns",
